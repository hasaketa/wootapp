 ...
 * Woot Plugin store.
 */
const ApplyWootStore = Reflux.createStore({
  /**
  ...
  onSubmitForm() {
    this.setState({
      username: 'usernameFromApplyWoot'
    });
  },
  ...
  storeDidUpdate(prevState) {
    debug('ApplyWoot store changed from', prevState, 'to', this.state);
...
export default ApplyWootStore;
export { ApplyWootStore };
